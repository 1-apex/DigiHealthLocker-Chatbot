...
def generate_augmented_patterns(patterns):
    ...
    for pattern in patterns:
        ...
        for token in doc:
            ...
            for synonym in synonyms:
                augmented_pattern = pattern.replace(token.text, synonym)
...
def find_best_match(user_input, intent_patterns):
    ...
    for pattern in intent_patterns:
        augmented_patterns = generate_augmented_patterns(pattern['patterns'])
